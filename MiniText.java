...
//		EINSENDEAUFGABE 11.02
		Action ausschneiden = new DefaultEditorKit.CutAction();
		ausschneiden.putValue(Action.SHORT_DESCRIPTION, "Ausschneiden");
		ausschneiden.putValue(Action.LARGE_ICON_KEY, new ImageIcon("icons/cut24.gif"));
		leiste.add(ausschneiden);
...
//	die Methode druckt das Dokument wenn dialogZeigen true ist, wird erst der Drucken-Dialog eingeblendet
...
//				ohne Dialog drucken dazu muss das dritte Argument false sein
